    ...
    <div className="body">
      ...
      <div className="container">
        <div className="row">
          ...
          You can add your own brand or others brands you may need in the `styles/brands.css` file. 
          You can add custom icons to `/public/icons/...`. It is recommended to use a 24x24 .SVG.
          ...
          Edit the "Short Intro" section tell users about yourself or your brand.
           */}
